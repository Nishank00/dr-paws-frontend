...
const AdminLayout = ({ children }) => {
  return (
    <div className="grid grid-cols-12 grid-rows-12 h-screen">
      ...
      <main className="col-span-12 row-span-10 md:col-start-3 md:col-span-10 md:row-span-11 shadow-md bg-primary4 overflow-y-scroll overflow-x-hidden p-6 text-primary">
        {children}
      </main>
