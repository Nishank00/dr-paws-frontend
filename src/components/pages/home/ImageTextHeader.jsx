...
const ImageTextHeader = ({
  ...
  return (
    <>
      <div className={`${isWidthFull ? 'w-full mx-6' : 'w-[292px] lowMob' } md:w-[320px] lg:w-auto grid grid-cols-1 lg:grid-cols-2 gap-3 overflow-hidden bg-white md:body-padding-x`}>
