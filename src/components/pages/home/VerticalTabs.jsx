    ...
    <>
      <div className="hidden lg:flex  h-full mt-[29px]">
        ...
        <div className=" flex flex-col w-[29%] flex-shrink-0">
          ...
          {/* <button
            className={`tab-button ${activeTab === index && "active-tab"} ${
              activeTab === "tab1" ? activeButonStyle : buttonStyle
            }`}
          ...
          {/* <button
            className={`tab-button ${activeTab === "tab2" && "active-tab"} ${
              activeTab === "tab2" ? activeButonStyle : buttonStyle
            }`}
          ...
          <button
            className={`tab-button ${activeTab === "tab3" && "active-tab"} ${
              activeTab === "tab3" ? activeButonStyle : buttonStyle
            }`}
          ...
          <button
            className={`tab-button ${activeTab === "tab4" && "active-tab"} ${
              activeTab === "tab4" ? activeButonStyle : buttonStyle
            }`}
          ...
          <button
            className={`tab-button ${activeTab === "tab5" && "active-tab"} ${
              activeTab === "tab5" ? activeButonStyle : buttonStyle
            }`}
          ...
          <button
            className={`tab-button ${activeTab === "tab6" && "active-tab"} ${
              activeTab === "tab6" ? activeButonStyle : buttonStyle
            }`}
          ...
          <button
            className={`tab-button ${activeTab === "" && "active-tab"} ${
              activeTab === "tab7" ? activeButonStyle : buttonStyle
            }`}
        ...
        <div className="flex flex-col items-stretch w-[71%] ml-5 max-md:w-full max-md:ml-0">
          ...
          {/* <div
            id="tab4"
            className={`tab-content ${activeTab === "tab4" ? "" : "hidden"}`}
          >
            <span className="justify-between items-center bg-orange-100 flex grow flex-col w-full px-16 py-10 max-md:max-w-full max-md:px-5">
              <div className="text-slate-700 text-2xl capitalize self-stretch max-md:max-w-full">
                Planned check-ups
          ...
          <div
            id="tab5"
            className={`tab-content ${activeTab === "tab5" ? "" : "hidden"}`}
          >
            <span className="justify-between items-center bg-orange-100 flex grow flex-col w-full px-16 py-10 max-md:max-w-full max-md:px-5">
              <div className="text-slate-700 text-2xl capitalize self-stretch max-md:max-w-full">
                Planned check-ups
          ...
          {/* <div
            id="tab6"
            className={`tab-content ${activeTab === "tab6" ? "" : "hidden"}`}
          >
            <span className="justify-between items-center bg-orange-100 flex grow flex-col w-full px-16 py-10 max-md:max-w-full max-md:px-5">
              <div className="text-slate-700 text-2xl capitalize self-stretch max-md:max-w-full">
                Planned check-ups
          ...
          <div
            id="tab7"
            className={`tab-content ${activeTab === "tab7" ? "" : "hidden"}`}
          >
            <span className="justify-between items-center bg-orange-100 flex grow flex-col w-full px-16 py-10 max-md:max-w-full max-md:px-5">
              <div className="text-slate-700 text-2xl capitalize self-stretch max-md:max-w-full">
                Planned check-ups
