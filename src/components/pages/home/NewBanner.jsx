...
const NewBanner = () => {
  ...
  return (
    <div
      className="flex  bg-[#CBD9E3]  items-center h-auto md:h-[85vh] text-white px-3 sm:px-16 md:px-44 pt-12 pb-8   lg:px-48 "
      style={{
        backgroundImage: `url(${
    ...
    >
      <div className=" w-full lg:w-2/3  flex-col flex justify-center gap-10 md:gap-12">
        <h2
          style={{ fontFamily: "Roca Bold, sans-serif" }}
          className=" text-3xl lg:w-[100%] w-[100%] m-auto md:text-[55px] leading-none custom-open-sans -mb-7 pt-2 lg:pt-0  font-bold px-[10px] md:px-0"
        >
          The veterinary <br />
          care our best <br />
          friends deserve
        </h2>
        <p  className="text-sm font-custom-open-sans leading-[18px] md:leading-[29.96px]  md:text-[22px] lg:w-[100%] w-[100%] m-auto font-semibold sm:font-light px-[10px] md:px-0">
          Book a visit now. <br /> Who will we be meeting?
        </p>

        <div className="flex gap-4 w-full justify-center lg:justify-start  relative cursor-pointer ">
          <BannerPetCard
            pet_type="Dog"
            width={"100px"}
            height={"150px"}
