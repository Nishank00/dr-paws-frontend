    ...
    return (
        <div  className="w-[100%] m-auto   grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1">
            {gridData.map((item, index) => (
                    <div className="flex flex-col items-stretch 2 max-md:w-full max-md:ml-0">
                    <img
                      loading="lazy"
                      ...
                      className="aspect-square object-contain object-center w-[245px] overflow-hidden shrink-0 max-w-full max-md:mt-5"
                    />
                  </div>
                ))}
        </div>
