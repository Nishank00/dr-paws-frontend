...
const SuggestionForm = () => {
  ...
  return (
    <div className="w-full rounded-lg bg-primary3 ">
      <div className="justify-center w-full items-center pt-8 md:pt-0 bg-primary3 flex rounded-lg flex-col">
        <img
          loading="lazy"
          ...
          className="aspect-[0.79] object-contain object-center min-w-[15px] md:min-w-[45px] overflow-hidden max-w-full mt-1 md:mt-9"
        />
        <div className="text-primary text-center  font-custom-roca text-sm md:text-2xl  capitalize self-stretch mt-3 mb-1 md:mt-10 ">
          Where should the next Dr. Paws Clinic be?
        </div>
      </div>
      <div className="w-[80%] pt-[20px] m-auto">
        <header className="text-center text-xl md:text-2xl text-primary font-custom-roca mb-8">
      ...
      <div className=" w-[80%] items-center m-auto bg-primary3 pb-[50px] flex flex-col justify-center rounded-md">
        ...
        <div className="w-full mt-0 md:mt-[18px] form-group mb-[6px]  grid grid-cols-1 md:grid-cols-2 gap-1 md:gap-5">
          <PhoneNumberInput
