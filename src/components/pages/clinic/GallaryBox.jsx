      ...
      {gridData.map((item, index) => (
        ...
        >
          ...
          ><img
            ...
            } object-contain object-center sm:w-[245px] overflow-hidden shrink-0 sm:max-w-full max-md:mt-5  h-auto transform transition-transform group-hover:scale-110`}
          /></a>
          {index == 7 && (
            <div
              onClick={openPopup}
