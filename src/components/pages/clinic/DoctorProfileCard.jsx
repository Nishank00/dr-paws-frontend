...
const DoctorProfileCard = ({
  ...
  return (
    <>
      <div className="justify-center shadow-md bg-primary3 md:p-5 p-4 rounded-xl items-stretch self-stretch flex min-w-[292px] md:min-w-min  max-w-[292px] flex-col">
        <img
          loading="lazy"
