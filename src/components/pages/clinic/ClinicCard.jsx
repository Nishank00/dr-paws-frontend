...
const ClinicCard = ({ imageUrl = "/home/clinic_image.png", clinic = {} }) => {
  ...
  return (
    <div className="bg-primary4 relative rounded-md cursor-pointer shadow-md flex flex-col transition ease-in-out delay-500 hover:shadoe-lg">
      ...
      >
        {clinic?.is_24_hr == "Y" ? (
          <p className="text-primary px-2 h-7 absolute -top-1 right-0 rounded-t-md text-sm md:text-lg text-center font-bold font-custom-open-sans bg-primary4 rounded-lg flex items-center justify-center">
            24 Hours
          </p>
        ) : (
          ""
