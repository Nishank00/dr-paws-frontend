...
const UserPofile = () => {
    ...
    return (
        <div style={{border:"1px solid red"}} className='w-full pt-[101px]'>
            {/* ProfileBox */}
            <div className='w-full flex flex-col sm:flex-col md:flex-row items-center lg:justify-between '>
                {/* Avatr Box */}
                ...
                {/* Profile details bOx */}
                <div style={{border:"1px solid red"}} className='w-[100%] sm:[w-100%] md:w-[82%]  grid grid-cols-1 sm:grid-cols-4 gap-2'>
                    {isEditMode ? (<>
                        <div style={{border:"1px solid red"}}  className='flex items-center justify-center'>
                            <div className="text-slate-700 text-2xl text-center sm:text-left h-10 italic font-semibold grow shrink basis-auto">
                            {userData.full_name}
                                {/* <input type="text" value={userData.full_name} onChange={(e) => setUserData({ ...userData, full_name: e.target.value })} /> */}
                            </div>
                            <div  style={{border:"1px solid red"}} className="text-slate-500 text-center sm:text-left text-sm leading-9 tracking-normal mt-5">
                                Contact No
                            </div>
                            <div className="text-slate-700 text-lgtext-center sm:text-left  font-semibold leading-8 tracking-normal ">
                                {userData.phone}
