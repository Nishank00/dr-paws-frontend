    ...
    return (
        <div onClick={() => router.push(`/pets/${id}`)} className='hover:cursor-pointer'>
            <div className={`items-stretch  border-${colorData.borderColor} bg-${colorData.borderColor} flex flex-col rounded-2xl border-[3px] border-solid flex-1`}>
                <div className={`items-center ${colorData.cardColor} flex flex-col px-10 py-8 rounded-2xl max-md:px-5`}>
                    {/* <img
                        loading="lazy"
                    ...
                    ></div>
                    <div className={`text-${index == 0 ? "white" : "secondary"} font-bold text-xl leading-6 capitalize mt-5`}>
                        {name || "NA"}
                    </div>
                </div>
                <div className="justify-center flex gap-1.5 px-4 py-2.5 items-start max-md:px-5">
                    <img
                        loading="lazy"
                    ...
                    />
                    <div className="text-white text-2xs leading-4 capitalize self-stretch">
                        Star Member
                    </div>
                    <img
                        loading="lazy"
