...
const NoVisitBox = () => {
  return (
    ...
    <div className="flex w-[321px] max-w-full flex-col items-stretch">
      ...
      <button className="text-slate-500 text-xl h-[55px] hover:bg-primary hover:text-white  font-bold whitespace-nowrap justify-center items-stretch border border-[color:var(--Secondary-1,#5281A2)] mt-5 px-5 rounded-full border-solid w-[200px] m-auto">
Book a Visit    </button>
    </div>
  </div>
  )
